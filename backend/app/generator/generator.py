...
class GenerationEngine:
        ...
        return {
            ...
            "function": {
                ...
                "description": (
                    ...
                    "14. 特定门型：提供 model_no + 可选的 color/substrate/thickness"
                ),
                "parameters": {
                    "type": "object",
                    "properties": {
                        "component_type": {
                            "type": "string",
                            "description": "组件类型：柜身、门板、护墙、吸塑柜门、铝框玻璃门、皮革门、免漆套装门、第二代铝木门、第二代铝框隐形门、饰面隐形门、套装门附件、异形件工艺费、双开门、子母门、特殊工艺产品、木抽盒及分线。客户说做柜子/柜体时用'柜身'，说门时用'门板'，说墙板/护墙时用'护墙'，说吸塑门/包覆门时用'吸塑柜门'，说铝框门/玻璃门时用'铝框玻璃门'，说皮革门/皮门时用'皮革门'，说套装门/室内门/房门时用'免漆套装门'，说铝木门时用'第二代铝木门'，说铝框隐形门时用'第二代铝框隐形门'，说隐形门/木质隐形门时用'饰面隐形门'，说哑口套/门套线/踢脚线/门楣板时用'套装门附件'，说工艺费/开孔费/木架费/圆弧工艺时用'异形件工艺费'，说双开门/对开门时用'双开门'，说子母门时用'子母门'，说格栅/圆弧护墙/铝立板/ABA加厚板/斜拼柜时用'特殊工艺产品'，说木抽盒/格子架/裤架/拉板抽/木分线时用'木抽盒及分线'。只要客户提到其中任何一个，就必须填。",
                        },
                        "model_no": {
                            "type": "string",
    ...
    def _build_system_prompt(self) -> str:
        ...
        return (
            ...
            "  '请问您是想做柜身、门板、护墙、吸塑柜门、铝框玻璃门、皮革门、免漆套装门、第二代铝木门、第二代铝框隐形门、饰面隐形门、套装门附件、异形件工艺费、双开门、子母门、特殊工艺产品还是木抽盒及分线呢？'\n\n"
            "【渐进式报价流程 — 每轮只做一步】\n"
