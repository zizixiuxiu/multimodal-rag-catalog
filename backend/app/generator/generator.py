...
class GenerationEngine:
        ...
        return {
            ...
            "function": {
                ...
                "description": (
                    ...
                    "12. 特殊工艺产品：提供 component_type='特殊工艺产品' + model_no(如饰面格栅/圆弧护墙/铝立板)\n"
                    "13. 木抽盒及分线：提供 component_type='木抽盒及分线' + model_no(如木抽盒/格子架/裤架/木分线)\n"
                    "14. PET门板：提供 component_type='PET门板' + color + substrate + thickness(18/22)\n"
                    "15. 爱格板：提供 component_type='爱格板' + color + model_no\n"
                    "16. EB板：提供 component_type='EB板' + color + model_no\n"
                    "17. 22厚门板：提供 component_type='22厚门板' + color + model_no\n"
                    "18. 吸塑配件：提供 component_type='吸塑配件' + model_no(如罗马柱/脚线/楣板/酒格)\n"
                    "19. 套装门五金：提供 component_type='套装门五金' + model_no(如门锁/合页/门吸)\n"
                    "20. 特定门型：提供 model_no + 可选的 color/substrate/thickness"
                ),
                "parameters": {
                    "type": "object",
                    "properties": {
                        "component_type": {
                            "type": "string",
                            "description": "组件类型：柜身、门板、护墙、吸塑柜门、铝框玻璃门、皮革门、免漆套装门、第二代铝木门、第二代铝框隐形门、饰面隐形门、套装门附件、异形件工艺费、双开门、子母门、特殊工艺产品、木抽盒及分线、PET门板、爱格板、EB板、22厚门板、吸塑配件、套装门五金。客户说做柜子/柜体时用'柜身'，说门时用'门板'，说墙板/护墙时用'护墙'，说吸塑门/包覆门时用'吸塑柜门'，说铝框门/玻璃门时用'铝框玻璃门'，说皮革门/皮门时用'皮革门'，说套装门/室内门/房门时用'免漆套装门'，说铝木门时用'第二代铝木门'，说铝框隐形门时用'第二代铝框隐形门'，说隐形门/木质隐形门时用'饰面隐形门'，说哑口套/门套线/踢脚线/门楣板时用'套装门附件'，说工艺费/开孔费/木架费/圆弧工艺时用'异形件工艺费'，说双开门/对开门时用'双开门'，说子母门时用'子母门'，说格栅/圆弧护墙/铝立板/ABA加厚板/斜拼柜时用'特殊工艺产品'，说木抽盒/格子架/裤架/拉板抽/木分线时用'木抽盒及分线'，说PET门/PET板时用'PET门板'，说爱格/爱格门板时用'爱格板'，说EB饰面/EB门板时用'EB板'，说22厚门/22厚板时用'22厚门板'，说吸塑罗马柱/脚线/顶线/楣板/酒格时用'吸塑配件'，说门锁/把手/合页/门吸/指纹锁时用'套装门五金'。只要客户提到其中任何一个，就必须填。",
                        },
                        "model_no": {
                            "type": "string",
    ...
    def _build_system_prompt(self) -> str:
        ...
        return (
            ...
            "【产品型号 — 特殊工艺产品】\n"
            "- 饰面格栅: 2160元/平方(35厚多层) | 2700元/平方(27厚颗粒板)\n"
            "- 圆弧护墙-饰面板: 1710元/平方 | PET: 2250元/平方\n"
            "- 圆弧线条: 75~135元/米(R24/R50/R70)\n"
            "- 铝立板: 960元/米 | ABA加厚板: 1140元/平方\n"
            "- 免漆45度斜拼柜组装工艺费: 210元/平方\n\n"
            "【产品型号 — 木抽盒及分线】\n"
            "- 木抽盒: 210~300元/个 | 格子架: 300~435元/个\n"
            "- 裤架: 255~375元/个 | 拉板抽: 150~225元/个\n"
            "- 木分线: 60元/条\n\n"
            "【产品型号 — PET门板】\n"
            "- 18mm PET(肤感): 冰山白/帷幔紫 447元/平方(颗粒板); 米杏灰/瓦石灰等 564元/平方(欧松板)\n"
            "- 18mm PET(亮光): 阿克雷里灰/高光济州灰/雪峰白/宝马灰 630元/平方(欧松板)\n"
            "- 18mm EB漆感: 幻彩米黄/罗曼尼红/香槟金拉丝等 594元/平方(欧松板)\n"
            "- 22mm PET(肤感): 浅霞灰S/燕羽灰/瓦石灰 654元/平方; 宝马灰 720元/平方\n\n"
            "【产品型号 — 爱格板】\n"
            "- W980铂金白: 660元/平方 | U702米兰灰绒: 870元/平方\n"
            "- H1379罗伦灰橡/H3158维察橡木等: 1080元/平方\n\n"
            "【产品型号 — EB板】\n"
            "- 斋浦尔红/湖水绿/伦敦灰/极光白/亚利桑那米/温太华卡其: 855元/平方\n\n"
            "【产品型号 — 22厚门板】\n"
            "- 淡雅杏黄/锯齿棕橡/马里兰棕/萨马拉白/拉普兰香榆: 660元/平方\n\n"
            "【产品型号 — 吸塑配件】\n"
            "- 罗马柱面板/脚线: 90~150元/米 | 顶线/灯线: 90~126元/米\n"
            "- 楣板: 249元/米 | 半月酒格: 369元/米 | 装饰框: 480元/平方\n"
            "- 单面/双面平板吸塑: 525~1575元/平方 | 台面: 480~780元/平方\n\n"
            "【产品型号 — 套装门五金】\n"
            "- 套装门锁具: 210~594元/套 | 指纹密码锁: 1740元/套\n"
            "- 子母合页: 45元/个 | 三维十字隐形合叶: 360元/个\n"
            "- 门吸: 30元/个 | 多功能液压合页: 360元/套 | 门地吸: 60元/套\n\n"
            "【报价工具 — 核心规则】\n"
            ...
            "- 客户说'格栅/圆弧护墙/铝立板/ABA加厚板/斜拼柜' → 理解为'特殊工艺产品'\n"
            "- 客户说'木抽盒/格子架/裤架/拉板抽/木分线' → 理解为'木抽盒及分线'\n"
            "- 客户说'PET门/PET板/PET门板' → 理解为'PET门板'\n"
            "- 客户说'爱格/爱格门板' → 理解为'爱格板'\n"
            "- 客户说'EB饰面/EB板' → 理解为'EB板'\n"
            "- 客户说'22厚门/22厚板' → 理解为'22厚门板'\n"
            "- 客户说'吸塑罗马柱/脚线/顶线/楣板/酒格' → 理解为'吸塑配件'\n"
            "- 客户说'门锁/把手/合页/门吸/指纹锁' → 理解为'套装门五金'\n"
            "- 如果客户没有明确说类型，工具会返回 component_type 选项，你必须追问：\n"
            "  '请问您是想做柜身、门板、护墙、吸塑柜门、铝框玻璃门、皮革门、免漆套装门、第二代铝木门、第二代铝框隐形门、饰面隐形门、套装门附件、异形件工艺费、双开门、子母门、特殊工艺产品、木抽盒及分线、PET门板、爱格板、EB板、22厚门板、吸塑配件还是套装门五金呢？'\n\n"
            "【渐进式报价流程 — 每轮只做一步】\n"
    ...
    def _welcome_result(self, session_id: Optional[str]) -> GenerationResult:
        ...
        welcome = (
            ...
            "• 📐 根据您的尺寸需求核算总价\n\n"
            "支持的产品包括：\n"
            "• 柜身、门板、护墙、PET门板、爱格板、EB板、22厚门板\n"
            "• 吸塑柜门、铝框玻璃门、皮革门\n"
            "• 免漆套装门、双开门、子母门\n"
            "• 第二代铝木门、第二代铝框隐形门、饰面隐形门\n"
            "• 套装门附件、套装门五金、吸塑配件\n"
            "• 异形件工艺费、特殊工艺产品、木抽盒及分线\n\n"
            "您可以告诉我：\n"
            "• 做什么产品？（如柜身、吸塑柜门、免漆套装门等）\n"
            "• 用什么型号、颜色和基材？\n"
            "• 面积或尺寸是多少？\n\n"
            "我来为您一步步引导报价～"
        )
